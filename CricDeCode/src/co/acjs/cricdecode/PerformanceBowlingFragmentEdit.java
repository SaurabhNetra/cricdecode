...
public class PerformanceBowlingFragmentEdit extends SherlockFragment{
	...
	EditText								overs, spells, maidens, runs, fours, sixes, wkts_left, wkts_right, catches_dropped, noballs, wides;
	ToggleButton							bowl_toggle;
	TableLayout								bowling_info;
	TextView								my_team, opponent_team, venue, day, month, year, level, match_overs, toggle_on, toggle_off;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		performanceBowlingFragmentEdit = this;
		View view = inflater.inflate(R.layout.performance_bowling_edit, container, false);
		return view;
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState){
		...
		init(view);
		((PerformanceFragmentEdit)getParentFragment()).viewInfo(PerformanceFragmentEdit.BOWLING);
		// Set Input Filter
	...
	public void init(View view){
		...
		catches_dropped = (EditText)view.findViewById(R.id.catches_dropped_bowling);
