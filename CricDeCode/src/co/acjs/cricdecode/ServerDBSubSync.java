...
public class ServerDBSubSync extends StackMobModel {
	String	user_id;
	String	order_id;
	String	token;
	String	sign;
	...
	public ServerDBSubSync(String user_id, String order_id, String token, String sign, int autorenewing, int initiation_ts_msec, int validUntil_ts_msec) {
		super(ServerDBSubSync.class);
