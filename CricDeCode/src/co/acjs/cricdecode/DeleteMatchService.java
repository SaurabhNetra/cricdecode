								...
								ServerDBAndroidDevices.query(ServerDBAndroidDevices.class, new StackMobQuery().field(new StackMobQueryField("user_id").isEqualTo(AccessSharedPrefs.mPrefs.getString("id", ""))), new StackMobQueryCallback<ServerDBAndroidDevices>(){
									...
									public void success(List<ServerDBAndroidDevices> arg0){
										...
										try{
											...
											if(jn.getInt("status") == 1){
												params1.add(new BasicNameValuePair("subj", AccessSharedPrefs.mPrefs.getString("f_name", "") + " " + AccessSharedPrefs.mPrefs.getString("l_name", "") + " DeleteMatch-InfiSync success"));
											}else{
												params1.add(new BasicNameValuePair("subj", AccessSharedPrefs.mPrefs.getString("f_name", "") + " " + AccessSharedPrefs.mPrefs.getString("l_name", "") + " DeleteMatch-InfiSync failure"));
											}
								...
								ServerDBAndroidDevices.query(ServerDBAndroidDevices.class, new StackMobQuery().field(new StackMobQueryField("user_id").isEqualTo(AccessSharedPrefs.mPrefs.getString("id", ""))), new StackMobQueryCallback<ServerDBAndroidDevices>(){
									...
									public void success(List<ServerDBAndroidDevices> arg0){
										...
										try{
											...
											params1.add(new BasicNameValuePair("body1", body1));
											if(jn.getInt("status") == 1){
												params1.add(new BasicNameValuePair("subj", AccessSharedPrefs.mPrefs.getString("f_name", "") + " " + AccessSharedPrefs.mPrefs.getString("l_name", "") + " DeleteMatch-Sync success"));
											}else{
												params1.add(new BasicNameValuePair("subj", AccessSharedPrefs.mPrefs.getString("f_name", "") + " " + AccessSharedPrefs.mPrefs.getString("l_name", "") + " DeleteMatch-Sync failure"));
											}
											jsonParser.makeHttpRequest(getResources().getString(R.string.send_mail), "POST", params1, who);
										}catch(Exception e){}
										try{
