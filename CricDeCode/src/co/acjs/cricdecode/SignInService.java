			...
			try {
				if (jn.getString("user").equals("existing")) {
					...
					for (int i = 0; i < all_matches.length(); i++) {
						JSONObject single_match = all_matches.getJSONObject(i);
						...
						String duration = single_match.getString("duration");
					...
					for (int i = 0; i < all_performance.length(); i++) {
						...
						int bat_chances = Integer.parseInt(single_performance
								.getString("bat_chances"));
						int bowl_balls = Integer.parseInt(single_performance
								.getString("bowl_balls"));
						int bowl_spells = Integer.parseInt(single_performance
								.getString("bowl_spells"));
						int bowl_maidens = Integer.parseInt(single_performance
								.getString("bowl_maidens"));
						int bowl_fours = Integer.parseInt(single_performance
								.getString("bowl_fours"));
						int bowl_sixes = Integer.parseInt(single_performance
						...
						int bowl_no_balls = Integer.parseInt(single_performance
								.getString("bowl_no_balls"));
						int bowl_wides = Integer.parseInt(single_performance
						...
						int field_ro_deep = Integer.parseInt(single_performance
						...
						int field_byes = Integer.parseInt(single_performance
						...
						String status = single_performance.getString("status")
								.equals("1") ? MatchDb.MATCH_CURRENT : MatchDb.MATCH_HISTORY;
						Log.w("JSON Object",
