...
public class MainActivity extends SherlockFragmentActivity {
	...
	ArrayList<Integer>					batting_no_val, how_out_val,
			season_val, my_team_val, opponent_val, venue_val, result_val,
			level_val, overs_val, innings_val, duration_val, first_val;
	...
	static final int					NO_FRAGMENT						= -1,
			SIGNIN_FRAGMENT = 9, PROFILE_FRAGMENT = 0, CAREER_FRAGMENT = 1,
			...
			PROFILE_EDIT = 8, ACCOUNT_CHOSEN = 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
			...
			public void onIabSetupFinished(IabResult result) {
				if (!result.isSuccess()) {
					// TODO Oh noes, there was a problem.
					Log.d("Billing",
							"Problem setting up In-app Billing: " + result);
				} else {
					// TODO Hooray, IAB is fully set up!
