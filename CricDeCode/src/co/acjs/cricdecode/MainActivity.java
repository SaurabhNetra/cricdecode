...
public class MainActivity extends SherlockFragmentActivity {
	...
	MultiSelectSpinner				batting_no_spinner, how_out_spinner,
			season_spinner, my_team_spinner, opponent_spinner, venue_spinner,
			result_spinner, level_spinner, overs_spinner, innings_spinner,
			duration_spinner, first_spinner;
	ArrayList<Integer>				batting_no_val, how_out_val, season_val,
			my_team_val, opponent_val, venue_val, result_val, level_val,
			overs_val, innings_val, duration_val, first_val;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (AccessSharedPrefs.mPrefs.getInt("height", 0) == 0) {
			AccessSharedPrefs.setInt(main_context, "height", AccessSharedPrefs.mPrefs
					.getInt("height", displaymetrics.heightPixels));
		}

		if (AccessSharedPrefs.mPrefs.getInt("width", 0) == 0) {
			AccessSharedPrefs.setInt(main_context, "width", AccessSharedPrefs.mPrefs
					.getInt("width", displaymetrics.widthPixels));
		}
			...
			public void onDrawerOpened(View drawerView) {
				...
				((TextView) mDrawerList.getChildAt(ONGOING_MATCHES_FRAGMENT)
						...
						.setText(getResources().getStringArray(
								R.array.drawer_list_item)[ONGOING_MATCHES_FRAGMENT] + "(" + AccessSharedPrefs.mPrefs
								.getInt("ongoingMatches", 0) + ")");
				((TextView) mDrawerList.getChildAt(DIARY_MATCHES_FRAGMENT)
						.findViewById(R.id.title))
						.setText(getResources().getStringArray(
								R.array.drawer_list_item)[DIARY_MATCHES_FRAGMENT] + "(" + AccessSharedPrefs.mPrefs
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			case android.R.id.home:
				...
				break;
			/* case R.string.new_match: preFragment = currentFragment; currentFragment = MATCH_CREATION_FRAGMENT; selectItem(MATCH_CREATION_FRAGMENT, true); onPrepareOptionsMenu(current_menu); break; case R.string.edit_profile: ProfileFragment.currentProfileFragment = ProfileFragment.PROFILE_EDIT_FRAGMENT; onPrepareOptionsMenu(current_menu); ProfileFragment.profileFragment.viewFragment(); break; case R.string.save_profile: ProfileEditFragment.profileEditFragment.saveEditedProfile(); ProfileFragment.currentProfileFragment = ProfileFragment.PROFILE_VIEW_FRAGMENT; onPrepareOptionsMenu(current_menu); ProfileFragment.profileFragment.viewFragment(); break; case R.string.create_match: MatchCreationFragment.matchCreationFragment.insertMatch(); onPrepareOptionsMenu(current_menu); break; case R.string.save_performance: PerformanceFragmentEdit.performanceFragmentEdit.insertOrUpdate(); onPrepareOptionsMenu(current_menu); break; case R.string.filter: showFilterDialog(currentFragment); break; */
			default:
				break;
		...
		switch (x) {
			case 0:
				if (android.os.Build.VERSION.SDK_INT < 16) {
					...
					((RelativeLayout) ((SherlockFragmentActivity) MainActivity.main_context)
							.findViewById(R.id.gen_tab))
							.setBackground(main_context.getResources()
									.getDrawable(
											R.drawable.tab_selected_selector));
					((RelativeLayout) ((SherlockFragmentActivity) MainActivity.main_context)
							.findViewById(R.id.bat_tab))
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
			...
			case R.id.delete_ongoing:
				...
				dialogText
						.setText("Are you sure you want to Delete this Match?");
			...
			case DIARY_MATCHES_FRAGMENT:
				...
				if (my_team_val != null) {
					...
					opponent_spinner.setSelection(opponent_val
							.toArray(new Integer[0]));
					venue_spinner.setSelection(venue_val
							.toArray(new Integer[0]));
					result_spinner.setSelection(result_val
							.toArray(new Integer[0]));
					level_spinner.setSelection(level_val
							.toArray(new Integer[0]));
					overs_spinner.setSelection(overs_val
							.toArray(new Integer[0]));
					innings_spinner.setSelection(innings_val
							.toArray(new Integer[0]));
					duration_spinner.setSelection(duration_val
							.toArray(new Integer[0]));
					first_spinner.setSelection(first_val
							.toArray(new Integer[0]));
					season_spinner.setSelection(season_val
							.toArray(new Integer[0]));
					...
					public void onClick(View v) {
						...
						String str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.season_whereClause = " and strftime('%Y'," + MatchDb.KEY_MATCH_DATE + ") in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.season_whereClause = " and strftime('%Y'," + MatchDb.KEY_MATCH_DATE + ") in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.myteam_whereClause = " and " + MatchDb.KEY_MY_TEAM + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.myteam_whereClause = " and " + MatchDb.KEY_MY_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.opponent_whereClause = " and " + MatchDb.KEY_OPPONENT_TEAM + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.opponent_whereClause = " and " + MatchDb.KEY_OPPONENT_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.venue_whereClause = " and " + MatchDb.KEY_VENUE + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.venue_whereClause = " and " + MatchDb.KEY_VENUE + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.result_whereClause = " and " + MatchDb.KEY_RESULT + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.result_whereClause = " and " + MatchDb.KEY_RESULT + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.level_whereClause = " and " + MatchDb.KEY_LEVEL + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.level_whereClause = " and " + MatchDb.KEY_LEVEL + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.overs_whereClause = " and " + MatchDb.KEY_OVERS + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.overs_whereClause = " and " + MatchDb.KEY_OVERS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.innings_whereClause = " and " + MatchDb.KEY_INNINGS + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.innings_whereClause = " and " + MatchDb.KEY_INNINGS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.duration_whereClause = " and " + MatchDb.KEY_DURATION + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.duration_whereClause = " and " + MatchDb.KEY_DURATION + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							DiaryMatchesFragment.diaryMatchesFragment.first_whereClause = " and " + MatchDb.KEY_FIRST_ACTION + " in(" + str + ")";
						} else {
							DiaryMatchesFragment.diaryMatchesFragment.first_whereClause = " and " + MatchDb.KEY_FIRST_ACTION + " in('')";
						}
					...
					public void onClick(View v) {
						...
						String str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.batting_no_whereClause = " and p." + PerformanceDb.KEY_BAT_NUM + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.batting_no_whereClause = " and p." + PerformanceDb.KEY_BAT_NUM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.how_out_whereClause = " and p." + PerformanceDb.KEY_BAT_HOW_OUT + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.how_out_whereClause = " and p." + PerformanceDb.KEY_BAT_HOW_OUT + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.season_whereClause = " and strftime('%Y',m." + MatchDb.KEY_MATCH_DATE + ") in(" + str + ")";
						} else {
							CareerFragment.careerFragment.season_whereClause = " and strftime('%Y',m." + MatchDb.KEY_MATCH_DATE + ") in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.myteam_whereClause = " and m." + MatchDb.KEY_MY_TEAM + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.myteam_whereClause = " and m." + MatchDb.KEY_MY_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.opponent_whereClause = " and m." + MatchDb.KEY_OPPONENT_TEAM + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.opponent_whereClause = " and m." + MatchDb.KEY_OPPONENT_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.venue_whereClause = " and m." + MatchDb.KEY_VENUE + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.venue_whereClause = " and m." + MatchDb.KEY_VENUE + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.result_whereClause = " and m." + MatchDb.KEY_RESULT + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.result_whereClause = " and m." + MatchDb.KEY_RESULT + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.level_whereClause = " and m." + MatchDb.KEY_LEVEL + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.level_whereClause = " and m." + MatchDb.KEY_LEVEL + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							CareerFragment.careerFragment.overs_whereClause = " and m." + MatchDb.KEY_OVERS + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.overs_whereClause = " and m." + MatchDb.KEY_OVERS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							CareerFragment.careerFragment.innings_whereClause = " and m." + MatchDb.KEY_INNINGS + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.innings_whereClause = " and m." + MatchDb.KEY_INNINGS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.duration_whereClause = " and m." + MatchDb.KEY_DURATION + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.duration_whereClause = " and m." + MatchDb.KEY_DURATION + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							CareerFragment.careerFragment.first_whereClause = " and m." + MatchDb.KEY_FIRST_ACTION + " in(" + str + ")";
						} else {
							CareerFragment.careerFragment.first_whereClause = " and m." + MatchDb.KEY_FIRST_ACTION + " in('')";
						}
					...
					public void onClick(View v) {
						...
						String str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.batting_no_whereClause = " and p." + PerformanceDb.KEY_BAT_NUM + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.batting_no_whereClause = " and p." + PerformanceDb.KEY_BAT_NUM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.how_out_whereClause = " and p." + PerformanceDb.KEY_BAT_HOW_OUT + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.how_out_whereClause = " and p." + PerformanceDb.KEY_BAT_HOW_OUT + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.season_whereClause = " and strftime('%Y',m." + MatchDb.KEY_MATCH_DATE + ") in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.season_whereClause = " and strftime('%Y',m." + MatchDb.KEY_MATCH_DATE + ") in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.myteam_whereClause = " and m." + MatchDb.KEY_MY_TEAM + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.myteam_whereClause = " and m." + MatchDb.KEY_MY_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.opponent_whereClause = " and m." + MatchDb.KEY_OPPONENT_TEAM + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.opponent_whereClause = " and m." + MatchDb.KEY_OPPONENT_TEAM + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.venue_whereClause = " and m." + MatchDb.KEY_VENUE + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.venue_whereClause = " and m." + MatchDb.KEY_VENUE + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.result_whereClause = " and m." + MatchDb.KEY_RESULT + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.result_whereClause = " and m." + MatchDb.KEY_RESULT + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.level_whereClause = " and m." + MatchDb.KEY_LEVEL + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.level_whereClause = " and m." + MatchDb.KEY_LEVEL + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.overs_whereClause = " and m." + MatchDb.KEY_OVERS + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.overs_whereClause = " and m." + MatchDb.KEY_OVERS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										true);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.innings_whereClause = " and m." + MatchDb.KEY_INNINGS + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.innings_whereClause = " and m." + MatchDb.KEY_INNINGS + " in(-2)";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.duration_whereClause = " and m." + MatchDb.KEY_DURATION + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.duration_whereClause = " and m." + MatchDb.KEY_DURATION + " in('')";
						}
						...
						str = DiaryMatchesFragment
								.buildSelectedItemString(
										...
										false);
						if (!str.equals("")) {
							AnalysisFragment.analysisFragment.first_whereClause = " and m." + MatchDb.KEY_FIRST_ACTION + " in(" + str + ")";
						} else {
							AnalysisFragment.analysisFragment.first_whereClause = " and m." + MatchDb.KEY_FIRST_ACTION + " in('')";
						}
		...
		if (Environment.MEDIA_MOUNTED.equals(state)) {
			try {
				...
				File projDir = new File(
						extStore.getAbsolutePath() + "/" + getResources()
								.getString(R.string.cricdecode_dir));
