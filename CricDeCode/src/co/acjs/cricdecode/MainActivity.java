		...
		switch (view.getId()) {
			case R.id.gen_tab:
				...
				if (android.os.Build.VERSION.SDK_INT < 16) {
					((RelativeLayout) findViewById(R.id.gen_tab))
							.setBackgroundDrawable(getResources().getDrawable(
									R.drawable.tab_selected_selector));
					((RelativeLayout) findViewById(R.id.bat_tab))
							.setBackgroundDrawable(getResources().getDrawable(
									R.drawable.tab_unselected_selector));
					((RelativeLayout) findViewById(R.id.bowl_tab))
							.setBackgroundDrawable(getResources().getDrawable(
									R.drawable.tab_unselected_selector));
					((RelativeLayout) findViewById(R.id.field_tab))
							.setBackgroundDrawable(getResources().getDrawable(
									R.drawable.tab_unselected_selector));
				} else {
					((RelativeLayout) findViewById(R.id.gen_tab))
