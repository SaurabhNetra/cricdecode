...
public class ProfileFragment extends SherlockFragment{
		...
		if(savedInstanceState != null){
			switch(currentProfileFragment){
				case PROFILE_VIEW_FRAGMENT:
					ProfileViewFragment.profileViewFragment = (ProfileViewFragment)getChildFragmentManager().getFragment(savedInstanceState, "currentFragmentInstance");
					break;
				case PROFILE_EDIT_FRAGMENT:
					ProfileEditFragment.profileEditFragment = (ProfileEditFragment)getChildFragmentManager().getFragment(savedInstanceState, "currentFragmentInstance");
					break;
				default:
					break;
			}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent){
		...
		if(ProfileEditFragment.profileEditFragment != null){
			ProfileEditFragment.profileEditFragment.onActivityResult(requestCode, resultCode, intent);
		}
	}
	...
	public void onSaveInstanceState(Bundle outState){
		...
		switch(currentProfileFragment){
			case PROFILE_VIEW_FRAGMENT:
				getChildFragmentManager().putFragment(outState, "currentFragmentInstance", ProfileViewFragment.profileViewFragment);
				((MainActivity)getSherlockActivity()).setPageName(0);
				break;
			case PROFILE_EDIT_FRAGMENT:
				getChildFragmentManager().putFragment(outState, "currentFragmentInstance", ProfileEditFragment.profileEditFragment);
